...
<div class="row">
    <div class="col-lg-3 col-md-6"><!-- col-lg-3 col-md-6 Starts -->
        ...
        <div style="font-size: 50px; display: flex; align-items: center; gap: 5px;">
        <i class="fa fa-money-bill-wave"></i> <span>Rp</span>
        </div>
        ...
        <div class="huge"> <?php echo number_format($count_total_earnings ? $count_total_earnings : 0, 0, ',', '.'); ?> </div>
